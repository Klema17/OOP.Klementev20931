...
HashTable& HashTable::operator=(const HashTable& b) { //оператор конструктора копирования
    if (this == &b){
        return *this;
    }
    current_size = b.current_size;
...
HashTable& HashTable::operator=(HashTable &&b){ // оператор конструктора перемещения
    if (this == &b){
        return *this;
    }
    current_size = b.current_size;
